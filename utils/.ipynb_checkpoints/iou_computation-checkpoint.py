...
def update_iou_stat(predict, gt, TP, P, T, num_classes = 5):
    """
...
def iter_iou_stat(predict, gt, num_classes = 5):
    """
    :param predict: the pred of each batch,  should be numpy array, after take the argmax   b,h,w
    :param gt: the gt label of the batch, should be numpy array     b,h,w
    :param TP: True positive
...
def compute_iou(TP, P, T, num_classes = 5):
    """
    :param TP:
    :param P:
    :param T:
...
def update_fraction_batchwise(mask, gt, fraction, num_classes = 5):
    """
...
def update_fraction_instancewise(mask, gt, fraction, num_classes = 5):
    """
    :param mask: True when belong to subgroup (memorized, correct, others) which we want to calculate fraction on
    :param gt: the gt label of the batch, numpy array
    :param fraction: fraction of pixels in the subgroup
...
def update_fraction_pixelwise(mask, gt, abs_num_and_total, num_classes = 5):
    """
    :param mask: True when belong to subgroup (memorized, correct, others) which we want to calculate fraction on
    :param gt: the gt label of the batch, numpy array
...
def iter_fraction_pixelwise(mask, gt, num_classes = 5):
    """
    :param mask: True when belong to subgroup (memorized, correct, others) which we want to calculate fraction on
    :param gt: the gt label of the batch, numpy array
    :param num_classes: number of classes in the dataset
